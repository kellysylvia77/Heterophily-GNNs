...
<tbody>
  ...
  <tr>
    <td class="tg-baqh">AutoGCN [2023]</td>
    <td class="tg-baqh">-</td>
    <td class="tg-baqh">-</td>
    <td class="tg-baqh">Wegt-aware</td>
    <td class="tg-baqh">-</td>
    <td class="tg-baqh">-</td>
  </tr>
  <tr>
    <td class="tg-baqh">GOAL [2023]</td>
    <td class="tg-baqh">-</td>
    <td class="tg-baqh">Stru &amp; Feat Sim</td>
    <td class="tg-baqh">-</td>
    <td class="tg-baqh">-</td>
    <td class="tg-baqh">-</td>
  </tr>
  <tr>
    <td class="tg-baqh">GOAT [2023]</td>
    <td class="tg-baqh">-</td>
    <td class="tg-baqh">-</td>
    <td class="tg-baqh">Wegt-aware</td>
    <td class="tg-baqh">-</td>
  ...
  <tr>
    <td class="tg-baqh">GraphTU [2023]</td>
    <td class="tg-baqh">-</td>
    <td class="tg-baqh">Stru &amp; Feat Sim</td>
    <td class="tg-baqh">-</td>
    <td class="tg-baqh">-</td>
  ...
  <tr>
    <td class="tg-baqh">Mid-GCN [2023]</td>
    <td class="tg-baqh">-</td>
    <td class="tg-baqh">-</td>
    <td class="tg-baqh">Wegt-aware</td>
    <td class="tg-baqh">-</td>
...
11. Homophily-Enhanced Self-Supervision for Graph Structure Learning: Insights and Directions, TNNLS [[paper](https://ieeexplore.ieee.org/stamp/stamp.jsp?tp=&arnumber=10106110)][[code](https://github.com/LirongWu/Homophily-Enhanced-Self-supervision)]
12. Alleviating Structural Distribution Shift in Graph Anomaly Detection, WSDM [[paper](http://staff.ustc.edu.cn/~hexn/papers/wsdm23-GDN.pdf)][[code](https://github.com/blacksingular/wsdm_GDN)]
13. SE-GSL: A General and Effective Graph Structure Learning Framework through Structural Entropy Optimization, WWW [[paper](https://penghao-bdsc.github.io/papers/A%20General%20and%20Effective%20Graph%20Structure%20Learning%20Framework%20through%20Structural%20Entropy%20Optimization.pdf)][[code]( https://github.com/RingBDStack/SE-GSL)]
14. Addressing Heterophily in Graph Anomaly Detection: A Perspective of Graph Spectrum, WWW [[paper](https://blacksingular.github.io/papers/www23-GHRN.pdf)][[code](https://github.com/blacksingular/GHRN)]
15. Robust Mid-Pass Filtering Graph Convolutional Networks, WWW [[paper](https://arxiv.org/pdf/2302.08048.pdf)]
16. Beyond Low-Pass Filtering: Graph Convolutional Networks With Automatic Filtering, TKDE [[paper](https://ieeexplore.ieee.org/stamp/stamp.jsp?tp=&arnumber=9806316)][[code]( https://github.com/nnzhan/AutoGCN)]
17. Finding the Missing-half: Graph Complementary Learning for Homophily-prone and Heterophily-prone Graphs, ICML openreview [[paper](https://openreview.net/pdf?id=KiUDs8yWX4)][[code](https://github.com/zyzisastudyreallyhardguy/GOAL-Graph-Complementary-Learning)]
18. Beyond Homophily: Reconstructing Structure for Graph-agnostic Clustering, ICML openreview [[paper](https://openreview.net/pdf?id=DZxkGYipRu)]
19. GOAT: A Global Transformer on Large-scale Graphs, ICML openreview [[paper](https://openreview.net/pdf?id=Le2dVIoQun)][[code](https://github.com/devnkong/GOAT)]
20. Topology Uncertainty Modeling For Imbalanced Node Classification on Graphs, ICASSP [[paper](https://ieeexplore.ieee.org/stamp/stamp.jsp?tp=&arnumber=10094813)]
...
2. Neural Sheaf Diffusion: A Topological Perspective on Heterophily and Oversmoothing in GNNs, NeurIPS [[paper](https://proceedings.neurips.cc/paper_files/paper/2022/file/75c45fca2aa416ada062b26cc4fb7641-Paper-Conference.pdf)][[code](https://github.com/twitter-research/neural-sheaf-diffusion)]
3. Simplified Graph Convolution with Heterophily, NeurIPS [[paper](https://proceedings.neurips.cc/paper_files/paper/2022/file/ae07d152c51ea2ddae65aa7192eb5ff7-Paper-Conference.pdf)]
4. From Local to Global: Spectral-Inspired Graph Neural Networks, NeurIPS [[paper](https://openreview.net/pdf?id=DhICIwGint_)][[code](
https://github.com/nhuang37/spectral-inspired-gnn)]
5. Decoupled Self-supervised Learning for Graphs, NeurIPS [[paper](https://proceedings.neurips.cc/paper_files/paper/2022/file/040c816286b3844fd78f2124eec75f2e-Paper-Conference.pdf)]
6. GARNET: Reduced-Rank Topology Learning for Robust and Scalable Graph Neural Networks, LoG [[paper](https://proceedings.mlr.press/v198/deng22a/deng22a.pdf)][[code](https://github.com/cornell-zhang/GARNET)]
7. Label-Wise Graph Convolutional Network for Heterophilic Graphs, LoG [[paper](https://openreview.net/pdf?id=HRmby7yVVuF)][[code](https://github.com/EnyanDai/LWGCN)]
8. Leave Graphs Alone: Addressing Over-Squashing without Rewiring, LoG [[paper](https://openreview.net/pdf?id=vEbUaN9Z2V8)]
9. Global-Local Graph Neural Networks for Node-Classification, LoG [[paper](https://openreview.net/pdf?id=YCgwkDo56q)]
10. GBK-GNN: Gated Bi-Kernel Graph Neural Networks for Modeling Both Homophily and Heterophily, WWW [[paper](https://arxiv.org/pdf/2110.15777.pdf)]
11. Designing the Topology of Graph Neural Networks: A Novel Feature Fusion Perspective, WWW [[paper](https://arxiv.org/pdf/2112.14531.pdf)][[code](https://github.com/AutoML-Research/F2GNN)]
...
13. Finding Global Homophily in Graph Neural Networks when Meeting Heterophily, ICML [[paper](https://proceedings.mlr.press/v162/li22ad/li22ad.pdf)][[code](https://github.com/RecklessRonan/GloGNN)]
14. Optimization-Induced Graph Implicit Nonlinear Diffusion, ICML [[paper](https://proceedings.mlr.press/v162/chen22z/chen22z.pdf)][[code](https://github.com/7qchen/GIND)]
15. NCGNN: Node-Level Capsule Graph Neural Network for Semisupervised Classification, TNNLS [[paper](https://ieeexplore.ieee.org/stamp/stamp.jsp?tp=&arnumber=9792205)]
16. Graph Decoupling Attention Markov Networks for Semisupervised Graph Node Classification, TNNLS [[paper](https://ieeexplore.ieee.org/stamp/stamp.jsp?tp=&arnumber=9744550)]
17. RAW-GNN: RAndom Walk Aggregation based Graph Neural Network, IJCAI [[paper](https://www.ijcai.org/proceedings/2022/0293.pdf)]
18. Block Modeling-Guided Graph Convolutional Neural Networks, AAAI [[paper](https://ojs.aaai.org/index.php/AAAI/article/view/20319)][[code]()]
19. Powerful Graph Convolutional Networks with Adaptive Propagation Mechanism for Homophily and Heterophily, AAAI [[paper](https://ojs.aaai.org/index.php/AAAI/article/view/20340)]
20. Deformable Graph Convolutional Networks, AAAI [[paper](https://ojs.aaai.org/index.php/AAAI/article/view/20765)][[code](https://github.com/mlvlab/DeformableGCN)]
21. Graph Pointer Neural Networks, AAAI [[paper](https://ojs.aaai.org/index.php/AAAI/article/view/20864)]
22. Graph Representation Learning Beyond Node and Homophily, TKDE [[paper](https://ieeexplore.ieee.org/stamp/stamp.jsp?tp=&arnumber=9695254)]
23. Understanding and Improving Graph Injection Attack by Promoting Unnoticeability, ICLR [[paper](https://openreview.net/pdf?id=wkMG8cdvh7-)][[code](https://github.com/LFhase/GIA-HAO)]
24. How does Heterophily Impact the Robustness of Graph Neural Networks? Theoretical Connections and Practical Implications, KDD [[paper](https://arxiv.org/pdf/2106.07767.pdf)][[code](https://github.com/GemsLab/HeteRobust)]
25. Memory-Based Message Passing: Decoupling the Message for Propagation from Discrimination, ICASSP [[paper](https://ieeexplore.ieee.org/stamp/stamp.jsp?tp=&arnumber=9747635)]
26. Non-Local Graph Neural Networks, TPAMI [[paper](https://ieeexplore.ieee.org/stamp/stamp.jsp?tp=&arnumber=9645300)]
